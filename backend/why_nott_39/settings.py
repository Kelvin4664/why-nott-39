"""
Django settings for why_nott_39 project.
...
WSGI_APPLICATION = 'why_nott_39.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "why_nott_39 API",
    "DESCRIPTION": "API documentation for why_nott_39 App",
    "VERSION": "v1",
}
